...
public class Farmer {
    ...
    public boolean isHasAnimals() { return hasAnimals;
    }

    public void setHasAnimals(boolean hasAnimals) {hasAnimals = hasAnimals;
    ...
    public void setHasPlants(boolean hasPlants) {hasPlants = hasPlants;
